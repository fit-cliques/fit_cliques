              ...
              async.series([
                function(cb) {
                  fbUserAuth.updateFbUserToken((err) => {
                    if (err) {
                      $window.location.href = 'https://www.fitbit.com/oauth2/authorize?response_type=code&client_id=227THV&redirect_uri=https%3A%2F%2Ffit-cliques.herokuapp.com%2Fresync&scope=activity%20profile&expires_in=604800'; // eslint-disable-line max-len
                    }
                    cb();
                  });
                },
